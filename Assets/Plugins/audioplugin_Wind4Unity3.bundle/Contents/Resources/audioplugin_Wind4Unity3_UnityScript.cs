...
public class audioplugin_Wind4Unity3GUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Wind4Unity3"; } }
    public override string Description    { get { return "Wind4Unity3"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
    [DllImport("audioplugin_Wind4Unity3")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_Wind4Unity3")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_Wind4Unity3")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Wind4Unity3")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Wind4Unity3")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Wind4Unity3")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Wind4Unity3")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
